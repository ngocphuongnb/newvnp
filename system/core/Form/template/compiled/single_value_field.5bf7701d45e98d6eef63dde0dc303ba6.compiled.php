<?php if(!class_exists('ntpl')){exit;}?><div class="form-group">
    ...
    <div class="col-sm-10">
    	<?php if( $Field["display"] == 'radio' ){ ?>
            ...
            <div class="radio">
                <label>
                    <input type="radio" name="Node[<?php echo $Field["name"];?>]" id="<?php echo $Field["name"];?>_opt_<?php echo $Option["value"];?>" value="<?php echo $Option["name"];?>" <?php if( $Field["value"] == $Option["name"] ){ ?>checked="checked"<?php } ?>>
