<?php if(!class_exists('ntpl')){exit;}?><div class="form-group clear">
    ...
    <div class="col-sm-10">
        ...
        <?php }elseif( $Field["display"] == 'checkbox' ){ ?>
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="Node[<?php echo $Field["name"];?>][]" id="<?php echo $Field["name"];?>_opt_<?php echo $Option["name"];?>" value="<?php echo $Option["name"];?>" <?php if( in_array($Option["name"],$Field["value"]) ){ ?>checked="checked"<?php } ?>>
