<?php if(!class_exists('ntpl')){exit;}?><div class="form-group">
    <label for="NodeType_name" class="col-sm-2 control-label"><?php echo $Field["label"];?></label>
   	<input type="hidden" class="form-control NodeField_MultiImages" name="Node[<?php echo $Field["name"];?>][]" id="NodeField_<?php echo $Field["name"];?>" value="" placeholder="<?php echo $Field["label"];?>"/>
    <div class="col-sm-10">
    	<div class="clearfix">
