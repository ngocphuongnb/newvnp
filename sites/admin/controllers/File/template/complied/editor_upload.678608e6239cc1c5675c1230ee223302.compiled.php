<?php if(!class_exists('ntpl')){exit;}?><div id="File_Actions">
    <ul class="nav nav-pills">
        ...
        -->
        <li><a href="<?php  echo ADMIN_BASE;?>ajax/text/File/list_files/"><span class="glyphicon glyphicon-th"></span>&nbsp;Open file manager</a></li>
