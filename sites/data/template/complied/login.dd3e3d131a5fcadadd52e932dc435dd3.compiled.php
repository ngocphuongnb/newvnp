...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php  echo DATA_DIR;?>library/bootstrap/Forms/css/bootstrap.min.css" />
        <link rel="stylesheet" type="text/css" href="<?php  echo DATA_DIR;?>library/bootstrap/Buttons/css/bootstrap.min.css" />
        <link rel="stylesheet" type="text/css" href="<?php  echo CDN_SERVER;?>/<?php  echo APPLICATION_DIR;?>/template/css/style.css" />
    </head>
    
    <body>
    	<div class="container">
        	<div class="row col-xs-4" id="LoginForm">
                <form name="UserLogin" method="post" action="<?php echo $loginAction;?>" class="form-horizontal" role="form">
