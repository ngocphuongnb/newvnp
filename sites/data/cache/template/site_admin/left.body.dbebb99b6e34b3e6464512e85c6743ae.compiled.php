            	...
            	<div class="col-xs-6 col-md-4" id="left-sidebar" role="navigation">
                	<ul id="admin-functions">
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                            	<li><a href="<?php  echo ADMIN_BASE;?>Comments/setting/">Cài đặt bình luận</a></li>
                                <li><a href="<?php  echo ADMIN_BASE;?>Comments/fb/">Bình luận Facebook</a></li>
                                <li><a href="<?php  echo ADMIN_BASE;?>Comments/google/">Bình luận Google</a></li>
                            </ul>
                      	</li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="<?php  echo ADMIN_BASE;?>Template/Help/">Hướng dẫn sử dụng</a></li>
                            </ul>
                      	</li>
                        <li>
