...
function SugarBox(BoxObject)
{
	...
	this.BuildSelector = function() {
		//self.SugarHead = self.SugarWrapper + ' ' + self.SugarHead;
		...
		//self.SugarBody = self.SugarWrapper + ' ' + self.SugarBody;
		self.BoxContent = self.SugarBody + ' ' + self.BoxContent;
		
		//self.BoxFoot = self.SugarWrapper + ' ' + self.BoxFoot;
	...
	this.OpenSugarBox = function(BoxObject) {
