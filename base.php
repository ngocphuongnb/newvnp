...
define('CONTROLLER_PATH', APPLICATION_PATH . 'controller' . DIRECTORY_SEPARATOR);
if(!defined('ADMIN_SECTION')) define('ADMIN_SECTION', false);

if(!@include(SYSTEM_PATH . 'functions.php')) die('Main functions file doesn\'t existed!');
if(!@include(SYSTEM_PATH . 'core/Boot/Boot.php')) die('Bootstrap load failed!');
if(!@include(APPLICATION_PATH . APPLICATION_NAME . '.php')) die('Application main file doesn\'t existed!');
if(!@include(APPLICATION_PATH . 'config.php')) die('Application config file doesn\'t existed!');
